...
PRETRAINED_MODEL = os.path.join(DATA_BASE_DIR, 'lsg-roberta-large')
...
class NERDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if random.random() < 0.2:
            ...
            num_spaces = min(num_spaces, 1536-len(curr_item['input_ids']))
...
data_collator = DataCollatorForTokenClassification(tokenizer, pad_to_multiple_of=1536)
